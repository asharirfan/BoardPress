	...
	final class LP_Course_Post_Type extends LP_Abstract_Post_Type {
		...
		static function assessment_meta_box() {
			...
			$meta_box = array(
				...
				'title'    => __( 'Course Assessment', 'learnpress' ),
				'priority' => 'high',
				'pages'    => array( LP_COURSE_CPT ),
				'fields'   => array(
					array(
		...
		static function payment_meta_box() {
			...
			$meta_box = array(
				'id'       => 'course_payment',
				'title'    => __( 'Course Payment Settings', 'learnpress' ),
				'priority' => 'high',
				'pages'    => array( LP_COURSE_CPT ),
				'fields'   => array(
					array(
		...
		private function _send_mail() {
			...
			$mail = LP()->mail;
			if ( ( $send = $mail->send( 'mrasharirfan@gmail.com', 'mrasharirfan@gmail.com', 'This is the subject', 'this is the content' ) ) !== true ) {
				echo 'error';
				print_r( $send );
				die();
			} else {
