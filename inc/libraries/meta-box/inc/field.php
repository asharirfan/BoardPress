...
if ( ! class_exists( 'RWMB_Field ' ) ) {
	class RWMB_Field {
		...
		static function add_clone_button() {
			return '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', 'learnpress'/*'meta-box'*/ ) . '</a>';
		}
		...
		static function remove_clone_button() {
			return '<a href="#" class="rwmb-button button remove-clone">' . __( '&#8211;', 'learnpress'/*'meta-box'*/ ) . '</a>';
		}
