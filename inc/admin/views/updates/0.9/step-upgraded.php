...
<ul>
	...
	<li>
		<a href="<?php echo admin_url( 'options-general.php?page=learn_press_settings' ); ?>"><?php _e( 'Setting up your LearnPress', 'learnpress' ); ?></a>
	</li>
	<li>
		<a href="<?php echo admin_url( 'admin.php?page=learn_press_add_ons' ); ?>"><?php _e( 'Manage add-ons', 'learnpress' ); ?></a>
	</li>
