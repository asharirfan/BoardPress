...
Plugin URI: http://asharirfan.com
Description: BoardPress is an interactive learning management system.
Author: BoardPress
Version: 1.0.0
Author URI: http://asharirfan.com
...
if ( !defined( 'LP_PLUGIN_PATH' ) ) {
	...
	define( 'LEARNPRESS_VERSION', '1.0.1' );
...
if ( !class_exists( 'LearnPress' ) ) {
	...
	class LearnPress {
		 ...
		 *
		 * @var BoardPress object
		 */
		private static $_instance = null;

		/**
		 * Store the file that define BoardPress
		 *
		 * @var null|string
		 */
		...
		/**
		 * BoardPress constructor
		 */
		public function __construct() {
			//echo "[BoardPress loaded]";
		...
		/**
		 * Init BoardPress when WP initialises
		 */
		function init() {
